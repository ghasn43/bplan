...
import type { ISWarning, Severity } from '@/types/incomeStatement'
...
export function StatementWarningBanner({ warnings }: { warnings: ISWarning[] }) {
      ...
      <button className="card__header" style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer' }} onClick={() => setOpen((o) => !o)}>
        <div className="card__header-main">
          ...
          <div style={{ textAlign: 'left' }}>
            <div className="card__title">Model review notes</div>
