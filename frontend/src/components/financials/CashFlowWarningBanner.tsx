...
import type { CashFlowWarning, Severity } from '@/types/cashFlow'
...
export function CashFlowWarningBanner({ warnings }: { warnings: CashFlowWarning[] }) {
      ...
      <button className="card__header" style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer' }} onClick={() => setOpen((o) => !o)}>
        <div className="card__header-main">
          ...
          <div style={{ textAlign: 'left' }}>
            <div className="card__title">Cash flow review notes</div>
