...
import type { BalanceSheetWarning, Severity } from '@/types/balanceSheet'
...
export function BalanceSheetWarningBanner({ warnings }: { warnings: BalanceSheetWarning[] }) {
      ...
      <button className="card__header" style={{ width: '100%', background: 'none', border: 'none', cursor: 'pointer' }} onClick={() => setOpen((o) => !o)}>
        <div className="card__header-main">
          ...
          <div style={{ textAlign: 'left' }}>
            <div className="card__title">Balance sheet review notes</div>
